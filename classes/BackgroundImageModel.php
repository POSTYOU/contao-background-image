...
{
    public function parseFrontendTemplateHook($strBuffer, $tmpName)
    {
    ...
    public function insertSytleTag($sourceFilePath, $pos, $strBuffer)
    {
        ...
        $strBuffer = preg_replace("/class=\"/", "class=\"" .$rID." background-image ", $strBuffer, 1);
